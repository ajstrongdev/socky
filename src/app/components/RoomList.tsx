...
function RoomList() {
    ...
    return (
        <>
            <div className="w-[85%] m-auto bg-green-100 rounded-lg border border-slate-700/50 px-8">
                    <h1 className="text-4xl font-bold mb-4 text-center py-8">Your Rooms:</h1>
                    <div className="grid grid-cols-2 md:gap-4 mb-4">
                        {userRoomList && userRoomList.length > 0 ? (
                            userRoomList.map((room, index) => (
                                <div key={index} className="bg-green-200 border border-slate-700/50 rounded-lg p-4 my-4 shadow-md">
